...
public class AdjustHelper {
  ...
  @Nullable private static FocusApplication focusApplication;

  public static void setupAdjustIfNeeded(FocusApplication application) {
    // RELEASE: Enable Adjust - This class has different implementations for all
    // build types.
    ...
    final AdjustConfig config =
        new AdjustConfig(application, BuildConfig.ADJUST_TOKEN,
                         BuildConfig.ADJUST_ENVIRONMENT, true);
    config.setOnAttributionChangedListener(new OnAttributionChangedListener() {
      ...
      public void onAttributionChanged(AdjustAttribution attribution) {
        ...
        final String key =
            application.getString(R.string.pref_key_s_tracker_token);
    ...
    application.registerActivityLifecycleCallbacks(
        new AdjustLifecycleCallbacks());
  }

  public static void trackEvent(String eventToken) {
    if (focusApplication != null &&
