...
/* package */ class LinkHandler implements View.OnLongClickListener {
  ...
  private @Nullable TabChromeClient chromeClient = null;
  ...
  public boolean onLongClick(View v) {
    ...
    case WebView.HitTestResult.SRC_ANCHOR_TYPE:
      ...
      chromeClient.onLongPress(
          new TabView.HitTarget(this.tabView, true, linkURL, false, null));
      return true;

    case WebView.HitTestResult.IMAGE_TYPE:
      final String imageURL = hitTestResult.getExtra();
      chromeClient.onLongPress(
          new TabView.HitTarget(this.tabView, false, null, true, imageURL));
      return true;
        ...
        public void handleMessage(Message msg) {
          ...
          if (url == null || src == null) {
            throw new IllegalStateException(
                "WebView did not supply url or src for image link");
          }

          if (chromeClient != null) {
            chromeClient.onLongPress(
                new TabView.HitTarget(tabView, true, url, true, src));
          }
        }
      });
