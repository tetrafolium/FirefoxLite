...
/**
 * Override {@link #findScrollingChild(View)} to support {@link ViewPager}'s
 * nested scrolling.
 *
 */
public class ViewPagerBottomSheetBehavior<V extends View>
  ...
  View findScrollingChild(View view) {
    ...
    // Previous approach uses DFS to find the scrolling child. Now we consider
    // the current selected page for ViewPager first, so the second page could
    // still gets touch event
  ...
  /**
   * A utility function to get the {@link ViewPagerBottomSheetBehavior}
   * associated with the {@code view}.
   *
   * @param view The {@link View} with {@link ViewPagerBottomSheetBehavior}.
   * @return The {@link ViewPagerBottomSheetBehavior} associated with the {@code
   *     view}.
   */
