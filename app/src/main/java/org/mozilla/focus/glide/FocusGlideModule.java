...
public class FocusGlideModule extends AppGlideModule {
  ...
  public void registerComponents(Context context, Glide glide,
    ...
    registry.prepend(InputStream.class, Bitmap.class,
                     new RegionFileDecoder(glide, getScreenWidth(context)));
    registry.prepend(FaviconModel.class, FaviconModel.class,
                     new FaviconModelLoaderFactory());
    registry.prepend(FaviconModel.class, Bitmap.class,
                     new FaviconDecoder(context, glide));
  }
