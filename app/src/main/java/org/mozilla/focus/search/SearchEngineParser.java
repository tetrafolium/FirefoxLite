...
/* package */ class SearchEngineParser {
  private static final String URLTYPE_SUGGEST_JSON =
  ...
  public static SearchEngine load(AssetManager assetManager, String identifier,
  ...
  @VisibleForTesting
  static SearchEngine load(String identifier, InputStream stream)
  ...
  private static void readSearchPlugin(XmlPullParser parser,
    ...
    if (!"SearchPlugin".equals(name) && !"OpenSearchDescription".equals(name)) {
      throw new XmlPullParserException(
          "Expected <SearchPlugin> or <OpenSearchDescription> as root tag: " +
          parser.getPositionDescription());
    }
  ...
  private static void readUrl(XmlPullParser parser, SearchEngine searchEngine)
      throws XmlPullParserException, IOException {
  ...
  private static void readShortName(XmlPullParser parser,
                                    SearchEngine searchEngine)
      throws IOException, XmlPullParserException {
  ...
  private static void readImage(XmlPullParser parser, SearchEngine searchEngine)
      throws IOException, XmlPullParserException {
    ...
    final byte[] raw =
        Base64.decode(uri.substring(IMAGE_URI_PREFIX.length()), Base64.DEFAULT);
