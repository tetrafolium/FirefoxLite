...
public class DownloadInfoProvider extends ContentProvider {
  ...
  static {
    sUriMatcher.addURI(DownloadContract.AUTHORITY, DownloadContract.PATH,
                       DownloadContract.CODE);
  }
  ...
  public Cursor query(@NonNull Uri uri, @Nullable String[] projection,
    ...
    Cursor cursor =
        queryBuilder.query(sqLiteDatabase, projection, selection, selectionArgs,
                           null, null, sortOrder,
                           getLimitParam(uri.getQueryParameter("offset"),
  ...
  public int delete(@NonNull Uri uri, @Nullable String selection,
    ...
    switch (sUriMatcher.match(uri)) {
    case DownloadContract.CODE:
      count = sqLiteDatabase.delete(Download.TABLE_DOWNLOAD, selection,
                                    selectionArgs);
      break;
    default:
      throw new UnsupportedOperationException("URI: " + uri);
  ...
  public int update(@NonNull Uri uri, @Nullable ContentValues contentValues,
    ...
    switch (sUriMatcher.match(uri)) {
    case DownloadContract.CODE:
      count = sqLiteDatabase.update(Download.TABLE_DOWNLOAD, contentValues,
