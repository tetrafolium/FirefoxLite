...
public class DownloadInfoDbHelper {
  ...
  private static final class OpenHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
      ...
      String CREATE_TABLE =
          CREATE_TABLE_IF_NOT_EXISTS + Download.TABLE_DOWNLOAD + "(" +
          Download._ID + " INTEGER PRIMARY KEY AUTOINCREMENT," +
          Download.DOWNLOAD_ID + " INTEGER," + Download.FILE_PATH + " TEXT," +
          Download.STATUS + " INTEGER," + Download.IS_READ +
          " INTEGER DEFAULT 0" // Download item default is unread
          + ")";
    ...
    public void onUpgrade(SQLiteDatabase sqLiteDatabase, int oldVersion,
      ...
      if (oldVersion < VERSION_ADD_STATUS_AND_UNREAD) {
        // add new column status and update all legacy data to
        // 'STATUS_SUCCESSFUL'
        ...
        sqLiteDatabase.execSQL("ALTER TABLE " + Download.TABLE_DOWNLOAD +
                               " ADD " + Download.IS_READ +
                               " INTEGER DEFAULT 0;");
        sqLiteDatabase.execSQL("UPDATE " + Download.TABLE_DOWNLOAD + " SET " +
                               Download.IS_READ + " = 1;");
      }
    }
  }
  ...
  private DownloadInfoDbHelper(Context context) {
    ...
    mOpenHelper =
        new OpenHelper(context, DATABASE_NAME, null, getDatabaseVersion());
  }

  private int getDatabaseVersion() { return VERSION_ADD_STATUS_AND_UNREAD; }

  public static synchronized DownloadInfoDbHelper
