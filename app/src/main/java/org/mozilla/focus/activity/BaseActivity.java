...
public abstract class BaseActivity extends AppCompatActivity {
  ...
  /**
   * Is called whenever the application locale has changed. Your Activity must
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    mLastLocale =
        LocaleManager.getInstance().getCurrentLocale(getApplicationContext());
  ...
  public void onConfigurationChanged(Configuration newConfig) {
    ...
    localeManager.correctLocale(this, getResources(),
                                getResources().getConfiguration());

    final Locale changed = localeManager.onSystemConfigurationChanged(
        this, getResources(), newConfig, mLastLocale);
  ...
  /**
   * Open the app preferences. Activities must not open SettingsActivity
   * themselves, or any locale changes performed by SettingsActivity might not
