...
public class Screenshot implements Serializable {
  ...
  // category is only set in a background thread since it's loading should be
  // async.
  @WorkerThread
  ...
  public int getCategoryVersion() { return categoryVersion; }
  ...
  public String toString() {
    return "Screenshot{"
        ...
        ", timestamp=" + timestamp + ", imageUri='" + imageUri + '\'' + '}';
  }
}
