...
public class HttpAuthenticationDialogBuilder {
  ...
  private String getUsername() { return usernameTextView.getText().toString(); }

  private String getPassword() { return passwordTextView.getText().toString(); }

  public void show() {
    dialog.show();
    int photonBlue =
        ContextCompat.getColor(context, R.color.paletteDarkBlueC100);
    ...
    dialog =
        new AlertDialog.Builder(context)
            ...
            .setPositiveButton(R.string.action_ok,
                               (dialog, whichButton) -> {
                                 if (okListener != null) {
                                   okListener.onOk(host, realm, getUsername(),
                                                   getPassword());
                                 }
                               })
