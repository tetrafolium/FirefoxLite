...
/**
 * A simple wrapper for SharedPreferences that makes reading preference a little
 * bit easier.
 */
public class Settings {

  public static final int STORAGE_MSG_TYPE_REMOVABLE_UNAVAILABLE =
      0x9527; // beautiful random number
  ...
  private Settings(Context context) {
    ...
    settingPreferenceWrapper =
        new SettingPreferenceWrapper(context.getContentResolver());
  }

  public SharedPreferenceLiveData<Boolean> shouldBlockImagesLiveData() {
    return booleanLiveData(R.string.pref_key_performance_block_images,
                           BLOCK_IMAGE_DEFAULT);
  }
  ...
  public void setBlockImages(boolean blockImages) {
    final String key =
        getPreferenceKey(R.string.pref_key_performance_block_images);
    preferences.edit().putBoolean(key, blockImages).apply();
  }

  public SharedPreferenceLiveData<Boolean> shouldBlockJavaScriptLiveData() {
    return booleanLiveData(R.string.pref_key_performance_block_java_script,
  ...
  public SharedPreferenceLiveData<Boolean> isNightModeEnablLiveData() {
    return booleanLiveData(R.string.pref_key_night_mode_enable,
                           NIGHT_MODE_DEFAULT);
  }

  public boolean isNightModeEnable() {
    return settingPreferenceWrapper.getBoolean(
        resources.getString(R.string.pref_key_night_mode_enable),
        NIGHT_MODE_DEFAULT);
  }
  ...
  public void setNightModeSpotlight(boolean enabled) {
    final String key =
        getPreferenceKey(R.string.pref_key_night_mode_brightness_dirty);
    preferences.edit().putBoolean(key, enabled).apply();
  }

  public boolean showNightModeSpotlight() {
    return settingPreferenceWrapper.getBoolean(
        resources.getString(R.string.pref_key_night_mode_brightness_dirty),
        false);
  }

  public boolean shouldShowFirstrun() {
    return newFeatureNotice.shouldShowLiteUpdate() ||
        !newFeatureNotice.hasShownFirstRun();
  }

  public boolean shouldSaveToRemovableStorage() {
    // FIXME: rely on String-array-order is not a good idea
    final String[] defined =
        resources.getStringArray(R.array.data_saving_path_values);

    final String key =
        getPreferenceKey(R.string.pref_key_storage_save_downloads_to);
    final String value = preferences.getString(key, defined[0]);

    return defined[0].equals(
        value); // assume the first item is for removable storage
  }
  ...
  public boolean shouldUseTurboMode() {
    return preferences.getBoolean(
        resources.getString(R.string.pref_key_turbo_mode), TURBO_MODE_DEFAULT);
  }
  ...
  public void setRemovableStorageStateOnCreate(boolean exist) {
    final String key = getPreferenceKey(
        R.string.pref_key_removable_storage_available_on_create);
  ...
  public int getShowedStorageMessage() {
    final String key =
        getPreferenceKey(R.string.pref_key_showed_storage_message);
  ...
  public String getLifeFeedSettings() {
    return preferences.getString(
        getPreferenceKey(R.string.pref_key_developer_option_life_feed), "0");
  }

  @Nullable
  public String getDefaultSearchEngineName() {
    return preferences.getString(
        getPreferenceKey(R.string.pref_key_search_engine), null);
  }

  public boolean didShowRateAppDialog() {
    return preferences.getBoolean(
        getPreferenceKey(R.string.pref_key_did_show_rate_app_dialog),
        DID_SHOW_RATE_APP_DEFAULT);
  }

  public void setRateAppDialogDidShow() {
    preferences.edit()
        .putBoolean(
            getPreferenceKey(R.string.pref_key_did_show_rate_app_dialog), true)
        .apply();
  }
  ...
  public void setRateAppDialogDidDismiss() {
    preferences.edit()
        .putBoolean(
            getPreferenceKey(R.string.pref_key_did_dismiss_rate_app_dialog),
            true)
        .apply();
  }
  ...
  public void setRateAppNotificationDidShow() {
    preferences.edit()
        .putBoolean(
            getPreferenceKey(R.string.pref_key_did_show_rate_app_notification),
            true)
        .apply();
  }
  ...
  public int getMenuPreferenceClickCount() {
    return preferences.getInt(
        getPreferenceKey(R.string.pref_key_setting_click_counter), 0);
  }

  public void addMenuPreferenceClickCount() {
    preferences.edit()
        .putInt(getPreferenceKey(R.string.pref_key_setting_click_counter),
                getMenuPreferenceClickCount() + 1)
        .apply();
  }

  public boolean isDefaultBrowserSettingDidShow() {
    return preferences.getBoolean(
        getPreferenceKey(R.string.pref_key_did_show_default_browser_setting),
        false);
  }

  public void setDefaultBrowserSettingDidShow() {
    preferences.edit()
        .putBoolean(getPreferenceKey(
                        R.string.pref_key_did_show_default_browser_setting),
                    true)
        .apply();
  }
  ...
  public boolean hasUnreadMyShot() {
    return preferences.getBoolean(
        getPreferenceKey(R.string.pref_has_unread_my_shot), false);
  }

  public void setHasUnreadMyShot(boolean hasUnreadMyShot) {
    preferences.edit()
        .putBoolean(getPreferenceKey(R.string.pref_has_unread_my_shot),
                    hasUnreadMyShot)
        .apply();
  }
  ...
  public boolean didShowShareAppDialog() {
    return preferences.getBoolean(
        getPreferenceKey(R.string.pref_key_did_show_share_app_dialog),
        DID_SHOW_SHARE_APP_DEFAULT);
  }

  public void setShareAppDialogDidShow() {
    preferences.edit()
        .putBoolean(
            getPreferenceKey(R.string.pref_key_did_show_share_app_dialog), true)
        .apply();
  }
  ...
  public int getAppCreateCount() {
    return preferences.getInt(
        getPreferenceKey(R.string.pref_key_app_create_counter), 0);
  }

  public void setDefaultSearchEngine(SearchEngine searchEngine) {
    preferences.edit()
        .putString(getPreferenceKey(R.string.pref_key_search_engine),
                   searchEngine.getName())
        .apply();
  }

  public float getNightModeBrightnessValue() {
    return settingPreferenceWrapper.getFloat(
        getPreferenceKey(R.string.pref_key_brightness),
        WindowManager.LayoutParams.BRIGHTNESS_OVERRIDE_NONE);
  }

  public void setNightModeBrightnessValue(float value) {
    preferences.edit()
        .putFloat(getPreferenceKey(R.string.pref_key_brightness), value)
        .apply();
  }

  public int getLastPromptInAppUpdateVersion() {
    return preferences.getInt(
        getPreferenceKey(R.string.pref_int_last_prompt_in_app_update_version),
        0);
  }

  public void setLastPromptInAppUpdateVersion(int version) {
    preferences.edit()
        .putInt(getPreferenceKey(
                    R.string.pref_int_last_prompt_in_app_update_version),
                version)
        .apply();
  }

  public static void
  updatePrefDefaultBrowserIfNeeded(Context context, boolean isDefaultBrowser) {
    final SharedPreferences sharedPreferences =
        PreferenceManager.getDefaultSharedPreferences(context);
    final Set<String> keySet = sharedPreferences.getAll().keySet();
    final String prefDefaultBrowser =
        context.getResources().getString(R.string.pref_key_default_browser);
    ...
    if (keySet.contains(prefDefaultBrowser) || isDefaultBrowser) {
      sharedPreferences.edit()
          .putBoolean(prefDefaultBrowser, isDefaultBrowser)
          .apply();
    }
  }

  public static void updatePrefString(Context context, String key,
                                      String value) {
    final SharedPreferences sharedPreferences =
        PreferenceManager.getDefaultSharedPreferences(context);
  ...
  public boolean canOverride(String prefKey,
                             @Settings.SettingPriority int priority) {
    final int currPriority = preferences.getInt(prefKey, Integer.MAX_VALUE);
    return priority > currPriority;
  }

  public void setPriority(String prefKey,
                          @Settings.SettingPriority int priority) {
    preferences.edit().putInt(prefKey, priority).apply();
  }

  public SharedPreferenceLiveData<Integer> intLiveData(int keyResId,
                                                       Integer defValue) {
    return SharedPreferenceLiveDataKt.intLiveData(
        preferences, resources.getString(keyResId), defValue);
  }

  public SharedPreferenceLiveData<String> stringLiveData(int keyResId,
                                                         String defValue) {
    return SharedPreferenceLiveDataKt.stringLiveData(
        preferences, resources.getString(keyResId), defValue);
  }

  public SharedPreferenceLiveData<Boolean> booleanLiveData(int keyResId,
                                                           Boolean defValue) {
    return SharedPreferenceLiveDataKt.booleanLiveData(
        preferences, resources.getString(keyResId), defValue);
  }

  public SharedPreferenceLiveData<Float> floatLiveData(int keyResId,
                                                       Float defValue) {
    return SharedPreferenceLiveDataKt.floatLiveData(
        preferences, resources.getString(keyResId), defValue);
  }

  public SharedPreferenceLiveData<Long> longLiveData(int keyResId,
                                                     Long defValue) {
    return SharedPreferenceLiveDataKt.longLiveData(
        preferences, resources.getString(keyResId), defValue);
  }
  ...
  public static class Event {
    ...
    public static final String ShowRateAppNotification =
        "show_rate_app_notification";

    public static final String PostSurveyNotification =
        "post_survey_notification";
    public static final String ShowMyShotOnBoardingDialog =
        "show_my_shot_on_boarding_dialog";
    public static final String FeatureSurveyWifiFinding =
        "feature_survey_wifi_finding";
    public static final String FeatureSurveyVpn = "feature_survey_vpn";

    // Indicate the express vpn app was downloaded before, it may or may not in
    ...
    public static final String ShowDownloadIndicatorIntro =
        "dl_indicator_intro";
  }
