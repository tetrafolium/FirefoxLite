...
public class CharacterValidator {
  ...
  // Note: this constructor fails when running in Robolectric: robolectric only
  // supports bitmaps with 4 bytes per pixel (
  // https://github.com/robolectric/robolectric/blob/master/robolectric-shadows/shadows-core/src/main/java/org/robolectric/shadows/ShadowBitmap.java#L540
  ...
  private Bitmap drawBitmap(String text) {
    Bitmap b =
        Bitmap.createBitmap(BITMAP_WIDTH, BITMAP_HEIGHT, Bitmap.Config.ALPHA_8);
