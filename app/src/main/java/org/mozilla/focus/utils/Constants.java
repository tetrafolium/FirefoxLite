...
public class Constants {
  ...
  public static final String ACTION_REQUEST_PERMISSION =
      "org.mozilla.action.REQUEST_PERMISSION";
   ...
   */
  public static final String ACTION_NOTIFY_RELOCATE_FINISH =
      "org.mozilla.action.RELOCATE_FINISH";

  /**
   * To indicate this intent is created when we were operating file
   */
  public static final String CATEGORY_FILE_OPERATION =
      "org.mozilla.category.FILE_OPERATION";

  /**
   * Option value for download id comes from Download Manager. Its value type
   * should be *long*
   */
  public static final String EXTRA_DOWNLOAD_ID =
      "org.mozilla.extra.download_id";
