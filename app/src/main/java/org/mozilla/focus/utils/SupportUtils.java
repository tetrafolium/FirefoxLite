...
public class SupportUtils {
  ...
  public static final String YOUR_RIGHTS_URI =
      "file:///android_res/raw/rights.html";
  public static final String PRIVACY_URL =
      "https://www.mozilla.org/privacy/firefox-rocket";
  ...
  static final String[] SUPPORTED_URLS = new String[] {
      BLANK_URL, FOCUS_ABOUT_URL, YOUR_RIGHTS_URI, PRIVACY_URL, ABOUT_URI};
  ...
  public static String getSumoURLForTopic(final Context context,
                                          final String topic) {
    String escapedTopic;
    try {
    ...
    try {
      ...
      // about ourselves:
      throw new IllegalStateException("Unable find package details for Focus",
                                      e);
    }
    ...
    return "https://support.mozilla.org/1/mobile/" + appVersion + "/" +
        osTarget + "/" + langTag + "/" + escapedTopic;
  }
  ...
  public static String getPrivacyURL() { return PRIVACY_URL; }

  public static String getYourRightsURI() { return YOUR_RIGHTS_URI; }

  public static String getAboutURI() { return ABOUT_URI; }
  ...
  private static void loadRights(final WebView webView) {
    ...
    final Resources resources =
        Locales.getLocalizedResources(webView.getContext());
    ...
    final String trademarkPolicyUrl =
        "https://www.mozilla.org/foundation/trademarks/policy/";
    final String gplUrl = "file:///android_asset/gpl.html";
    final String trackingProtectionUrl =
        "https://wiki.mozilla.org/Security/Tracking_protection#Lists";
    final String licensesUrl = "file:///android_asset/licenses.html";

    final String content1 =
        resources.getString(R.string.your_rights_content1, appName, mozilla);
    substitutionMap.put("%your-rights-content1%", content1);

    final String content2 = resources.getString(R.string.your_rights_content2,
                                                appName, mplUrl, mpl);
    substitutionMap.put("%your-rights-content2%", content2);

    final String content3 =
        resources.getString(R.string.your_rights_content3, appName,
                            trademarkPolicyUrl, mozilla, firefox);
    substitutionMap.put("%your-rights-content3%", content3);

    final String content4 = resources.getString(R.string.your_rights_content4,
                                                appName, licensesUrl);
    substitutionMap.put("%your-rights-content4%", content4);

    final String content5 = resources.getString(
        R.string.your_rights_content5, appName, gplUrl, trackingProtectionUrl);
    substitutionMap.put("%your-rights-content5%", content5);

    final String data = HtmlLoader.loadResourceFile(
        webView.getContext(), R.raw.rights, substitutionMap);
    webView.loadDataWithBaseURL(getYourRightsURI(), data, "text/html", "UTF-8",
                                null);
  }
  ...
  private static void loadAbout(final WebView webView) {
    ...
    final String webviewVersion =
        DebugUtils.loadWebViewVersion(webView.getContext());

    final Map<String, String> substitutionMap = new ArrayMap<>();
    final String appName =
        webView.getContext().getResources().getString(R.string.app_name);
    final String mozilla =
        webView.getContext().getResources().getString(R.string.mozilla);
    final String aboutBody = webView.getContext().getResources().getString(
        R.string.about_content_body, appName, mozilla);

    final String aboutURI = SupportUtils.getAboutURI();
    final String learnMoreURL = SupportUtils.getManifestoURL();
    final String supportURL =
        SupportUtils.getSumoURLForTopic(webView.getContext(), "rocket-help");
    final String rightURL = SupportUtils.getYourRightsURI();
    final String privacyURL = SupportUtils.getPrivacyURL();
    final String feedURL = SupportUtils.getSumoURLForTopic(webView.getContext(),
                                                           "firefox-lite-feed");

    final String linkLearnMore =
        resources.getString(R.string.about_link_learn_more);
    final String linkSupport = resources.getString(R.string.about_link_support);
    final String linkYourRights =
        resources.getString(R.string.about_link_your_rights);
    ...
    final String linkLifeFeed =
        resources.getString(R.string.about_link_life_feed, lifeFeed);

    String aboutVersion = "";
    try {
      aboutVersion = context.getPackageManager()
                         .getPackageInfo(context.getPackageName(), 0)
                         .versionName;
    } catch (PackageManager.NameNotFoundException e) {
    ...
    final String aboutContent = resources.getString(
        R.string.about_content, aboutBody, learnMoreURL, linkLearnMore,
        supportURL, linkSupport, rightURL, linkYourRights, privacyURL,
        linkPrivacy, feedURL, linkLifeFeed);
    substitutionMap.put("%about-content%", aboutContent);

    final String wordmark = HtmlLoader.loadDrawableAsDataURI(
        webView.getContext(), R.drawable.ic_firefox_lite_logo,
        R.color.about_logo_color);
    substitutionMap.put("%wordmark%", wordmark);

    substitutionMap.put("%webview-version%", webviewVersion);

    final String data = HtmlLoader.loadResourceFile(
        webView.getContext(), R.raw.about, substitutionMap);
    // We use a file:/// base URL so that we have the right origin to load
    // file:/// css and image resources.
