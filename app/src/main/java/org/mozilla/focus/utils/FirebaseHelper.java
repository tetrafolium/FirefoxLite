...
final public class FirebaseHelper {
  ...
  public static final String RATE_APP_DIALOG_TEXT_TITLE =
      "rate_app_dialog_text_title";
  public static final String RATE_APP_DIALOG_TEXT_CONTENT =
      "rate_app_dialog_text_content";
  public static final String RATE_APP_DIALOG_TEXT_POSITIVE =
      "rate_app_dialog_text_positive";
  public static final String RATE_APP_DIALOG_TEXT_NEGATIVE =
      "rate_app_dialog_text_negative";
  ...
  static final String RATE_APP_NOTIFICATION_THRESHOLD =
      "rate_app_notification_threshold";
  ...
  static final String SCREENSHOT_CATEGORY_MANIFEST =
      "screenshot_category_manifest";
  ...
  static final String FIRST_LAUNCH_NOTIFICATION_MESSAGE =
      "first_launch_notification_message";
  static final String ENABLE_LIFE_FEED = "enable_life_feed";
  static final String LIFE_FEED_PROVIDERS = "life_feed_providers";
  static final String STR_E_COMMERCE_SHOPPINGLINKS =
  ...
  private static final String FIREBASE_CRASH_REPORT =
  ...
  static final String STR_SHARE_APP_DIALOG_CONTENT =
      "str_share_app_dialog_content";
  ...
  public static final String STR_MENU_BOTTOM_BAR_ITEMS =
      "str_menu_bottom_bar_items";
  public static final String STR_PRIVATE_BOTTOM_BAR_ITEMS =
      "str_private_bottom_bar_items";

  public static final String BOOL_IN_APP_UPDATE_SHOW_INTRO =
      "bool_in_app_update_show_intro";
  public static final String STR_IN_APP_UPDATE_CONFIG =
      "str_in_app_update_config";
  ...
  /**
   *  The entry point to inject FirebaseContract and start the library. This
   * method can only be called once or a IllegalStateException will be thrown.
   * @param context The entry point to inject FirebaseContract and start the
   *     library.
  ...
  public static void init(final Context context, boolean enabled) {
    ...
    if (firebaseContract == null) {
      ...
      // if firebaseContract is only used to initialized Firebase Helper once.
      // It doesn't make sense to use the new contract to initialize again.
  ...
  /**
   * This method should only be used for tests. We replace FirebaseContract. to
  ...
  private static FirebaseContract provideFirebaseImpl(Context context) {
    ...
    final String crashReport =
        getStringResourceByName(context, FIREBASE_CRASH_REPORT);
    ...
    final String projectId =
        getStringResourceByName(context, FIREBASE_PROJECT_ID);
  ...
  /**
   * @param applicationContext Used to disable Firebase Analytics. Allow null
   *     for Unit Tests.
   * @param enable If true, enable Firebase Analytics.
   */
  public static void enableAnalytics(@Nullable final Context applicationContext,
  ...
  private static void initInternal(final Context applicationContext) {
    ...
    firebaseContract.enableRemoteConfig(applicationContext, () -> {
      ThreadUtils.postToBackgroundThread(() -> {
        ...
        final boolean canOverride = settings.canOverride(
            PREF_INT_NEWS_PRIORITY, Settings.PRIORITY_FIREBASE);
        Log.d(NewsSourceManager.TAG, "Remote Config fetched");
        if (!TextUtils.isEmpty(source) &&
            (canOverride || TextUtils.isEmpty(settings.getNewsSource()))) {
          Log.d(NewsSourceManager.TAG, "Remote Config is used:" + source);
          settings.setPriority(PREF_INT_NEWS_PRIORITY,
                               Settings.PRIORITY_FIREBASE);
          settings.setNewsSource(source);
          NewsSourceManager.getInstance().setNewsSource(source);
        }
        final String url =
            AppConfigWrapper.getNewsProviderUrl(settings.getNewsSource());
        ThreadUtils.postToMainThread(
            () -> NewsSourceManager.getInstance().setNewsSourceUrl(url));

        LocalBroadcastManager.getInstance(applicationContext)
            .sendBroadcast(new Intent(FirebaseHelper.FIREBASE_READY));
      });
    });
  }

  @NonNull
  private static String getStringResourceByName(@NonNull Context context,
  ...
  /**
   * @param context Some default values are from resource string, if context is
   *     null and they'll be null.
   * @return A Hashmap contains key-value pair for remote config default value
   */
  private static HashMap<String, Object>
  provideDefaultValues(@Nullable Context context) {
    final HashMap<String, Object> map = new HashMap<>();
    if (context != null) {
      map.put(FirebaseHelper.RATE_APP_DIALOG_TEXT_TITLE,
              context.getString(R.string.rate_app_dialog_text_title,
                                context.getString(R.string.app_name)));
      map.put(FirebaseHelper.RATE_APP_DIALOG_TEXT_CONTENT,
              context.getString(R.string.rate_app_dialog_text_content));
      map.put(FirebaseHelper.RATE_APP_DIALOG_TEXT_POSITIVE,
              context.getString(R.string.rate_app_dialog_btn_go_rate));
      map.put(FirebaseHelper.RATE_APP_DIALOG_TEXT_NEGATIVE,
              context.getString(R.string.rate_app_dialog_btn_feedback));
      map.put(FirebaseHelper.FIRST_LAUNCH_NOTIFICATION_MESSAGE,
              context.getString(R.string.preference_default_browser) +
                  "?\uD83D\uDE0A");
      // Share App
      map.put(FirebaseHelper.STR_SHARE_APP_DIALOG_TITLE,
              context.getString(R.string.share_app_dialog_text_title,
                                context.getString(R.string.app_name)));
      map.put(FirebaseHelper.STR_SHARE_APP_DIALOG_CONTENT,
              context.getString(R.string.share_app_dialog_text_content));
      final String shareAppDialogMsg = context.getString(
    ...
    map.put(FirebaseHelper.RATE_APP_DIALOG_THRESHOLD,
            DialogUtils.APP_CREATE_THRESHOLD_FOR_RATE_DIALOG);
    map.put(FirebaseHelper.RATE_APP_NOTIFICATION_THRESHOLD,
            DialogUtils.APP_CREATE_THRESHOLD_FOR_RATE_NOTIFICATION);
    map.put(FirebaseHelper.SHARE_APP_DIALOG_THRESHOLD,
            DialogUtils.APP_CREATE_THRESHOLD_FOR_SHARE_DIALOG);
    map.put(FirebaseHelper.ENABLE_MY_SHOT_UNREAD,
            AppConfigWrapper.ENABLE_MY_SHOT_UNREAD_DEFAULT);
    map.put(FirebaseHelper.BANNER_MANIFEST,
            HomeFragment.BANNER_MANIFEST_DEFAULT);
    map.put(FirebaseHelper.FEATURE_SURVEY,
            RemoteConfigConstants.INSTANCE.getFEATURE_SURVEY_DEFAULT());
    map.put(FirebaseHelper.SCREENSHOT_CATEGORY_MANIFEST,
            ScreenshotManager.SCREENSHOT_CATEGORY_MANIFEST_DEFAULT);
    map.put(FirebaseHelper.VPN_RECOMMENDER_PACKAGE,
            FeatureSurveyViewHelper.Constants.PACKAGE_RECOMMEND_VPN);
    map.put(FirebaseHelper.VPN_RECOMMENDER_URL,
            FeatureSurveyViewHelper.Constants.LINK_RECOMMEND_VPN);
    map.put(FirebaseHelper.FIRST_LAUNCH_TIMER_MINUTES,
            FirstLaunchWorker.TIMER_DISABLED);
    map.put(FirebaseHelper.ENABLE_LIFE_FEED,
            AppConfigWrapper.LIFE_FEED_ENABLED_DEFAULT);
    map.put(FirebaseHelper.LIFE_FEED_PROVIDERS,
            AppConfigWrapper.LIFE_FEED_PROVIDERS_DEFAULT);
    map.put(FirebaseHelper.STR_E_COMMERCE_SHOPPINGLINKS,
            AppConfigWrapper.STR_E_COMMERCE_SHOPPINGLINKS_DEFAULT);
    map.put(FirebaseHelper.STR_E_COMMERCE_COUPONS,
            AppConfigWrapper.STR_E_COMMERCE_COUPONS_DEFAULT);
    map.put(FirebaseHelper.STR_COUPON_BANNER_MANIFEST,
            AppConfigWrapper.STR_E_COMMERCE_COUPON_BANNER_DEFAULT);
  ...
  public static void setUserProperty(Context context, String tag,
                                     String value) {
    checkFirebaseInitState();
