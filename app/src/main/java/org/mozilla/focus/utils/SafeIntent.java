...
/**
 * External applications can pass values into Intents that can cause us to
 * crash: in defense, we wrap {@link Intent} and catch the exceptions they may
 * force us to throw. See bug 1090385 for more.
 */
public class SafeIntent {
  private static final String LOGTAG =
      "Gecko" + SafeIntent.class.getSimpleName();

  private final Intent intent;

  public SafeIntent(final Intent intent) { this.intent = intent; }
  ...
  public boolean hasExtra(String name) {
    try {
      ...
      Log.w(LOGTAG,
            "Couldn't determine if intent had an extra: OOM. Malformed?");
      return false;
  ...
  public boolean getBooleanExtra(final String name,
  ...
  public <T extends Parcelable> ArrayList<T>
  getParcelableArrayListExtra(final String name) {
    try {
  ...
  public String getAction() { return intent.getAction(); }
  ...
  public Intent getUnsafe() { return intent; }
}
