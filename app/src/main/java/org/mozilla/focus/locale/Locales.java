...
public class Locales {
  ...
  /**
   * Is only required by locale aware activities, AND  Application. In most
   * cases you should be using BaseActivity or friends.
   *
   * @param context
   */
  public static void initializeLocale(Context context) {
    StrictModeViolation.<Void>tempGrant(
        builder -> builder.permitDiskReads().permitDiskWrites(), () -> {
  ...
  /**
   * Get a set of all countries (lowercase) in the list of default locales for
   * this device.
   */
  ...
  public static Resources getLocalizedResources(Context context) {
    ...
    final Locale currentLocale =
        LocaleManager.getInstance().getCurrentLocale(context);
    ...
    final Configuration configuration =
        new Configuration(currentResources.getConfiguration());
