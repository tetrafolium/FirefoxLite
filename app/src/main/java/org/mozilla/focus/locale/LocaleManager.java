 ...
 * this.
 * * It's lazy.
 * * It relies on using the SharedPreferences file owned by the app for
 * performance.
 */
public class LocaleManager {
  ...
  private static final AtomicReference<LocaleManager> instance =
      new AtomicReference<LocaleManager>();
  ...
  public void initialize(final Context context) {
    ...
    receiver = new BroadcastReceiver() {
      ...
      public void onReceive(Context context, Intent intent) {
        ...
        Log.d(LOG_TAG,
              "System locale changed from " + current + " to " + systemLocale);
      }
    };
  ...
  public boolean systemLocaleDidChange() { return systemLocaleDidChange; }

  /**
   * Every time the system gives us a new configuration, it
   * carries the external locale. Fix it.
   */
  public void correctLocale(Context context, Resources res,
   ...
   */
  public Locale
  onSystemConfigurationChanged(final Context context, final Resources resources,
                               final Configuration configuration,
                               final Locale currentActivityLocale) {
  ...
  getPackagedLocaleTags(final Context context) {
    return LocaleList.BUNDLED_LOCALES;
  }

  public static String getFallbackLocaleTag() { return FALLBACK_LOCALE_TAG; }
}
