...
public class TabEntity {  
  ...
  @PrimaryKey @NonNull @ColumnInfo(name = "tab_id") private String id;  

  @ColumnInfo(name = "tab_parent_id") private String parentId;  

  @ColumnInfo(name = "tab_title") private String title;  

  @ColumnInfo(name = "tab_url") private String url;
