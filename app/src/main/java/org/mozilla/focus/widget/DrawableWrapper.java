...
/**
 * DrawableWrapper was added since API Level 23. But in v7 support library, it
 * has annotation
 * "@RestrictTo(LIBRARY_GROUP)". Hence we should not extends it, so we create
 * this wrapper for now. Once we start to support API 23, or v7-support-library
 * allows us to extends its DrawableWrapper, then this file can be removed.
 */
...
public class DrawableWrapper extends Drawable {
  ...
  public DrawableWrapper(@NonNull Drawable drawable) { mWrapped = drawable; }

  public Drawable getWrappedDrawable() { return mWrapped; }
