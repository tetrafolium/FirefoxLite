...
public class ShiftDrawable extends DrawableWrapper {
  ...
  public ShiftDrawable(@NonNull Drawable d) { this(d, DEFAULT_DURATION); }
  ...
  public ShiftDrawable(@NonNull Drawable d, int duration,
    ...
    mAnimator.setInterpolator((interpolator == null) ? new LinearInterpolator()
                                                     : interpolator);
  ...
  private void updateBounds() {
    ...
    // draw round to head of progressbar. I know it looks stupid, don't blame me
    // now.
    mPath = new Path();
    mPath.addRect(b.left, b.top, b.left + width - radius, b.height(),
                  Path.Direction.CCW);
    mPath.addCircle(b.left + width - radius, radius, radius,
                    Path.Direction.CCW);
  }
