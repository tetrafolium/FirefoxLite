...
public class RocketMessagingService extends FirebaseMessagingServiceWrapper {
  ...
  public void onRemoteMessage(Intent intent, String title, String body) {
    ...
    intent.setClassName(getApplicationContext(),
                        AppConstants.LAUNCHER_ACTIVITY_ALIAS);

    final PendingIntent pendingIntent =
        PendingIntent.getActivity(this, 0, intent, PendingIntent.FLAG_ONE_SHOT);

    final NotificationCompat.Builder builder =
        NotificationUtil.importantBuilder(this).setContentIntent(pendingIntent);
    ...
    NotificationUtil.sendNotification(this, NotificationId.FIREBASE_AD_HOC,
                                      builder);
  }
}