...
public class NotificationUtil {
  ...
  private static final String LOW_PRIORITY_CHANNEL_ID =
      "low_priority_channel_id";

  private static final String PRIVATE_MODE_CHANNEL_ID =
      "private_mode_channel_id";
    ...
    final NotificationCompat.Builder builder =
        new NotificationCompat.Builder(context, channelId)
            ...
            .setColor(ContextCompat.getColor(context,
                                             R.color.surveyNotificationAccent))
            .setAutoCancel(true);
  ...
  // DEFAULT_VIBRATE makes notifications can show heads-up for Android 7 and
  // below
  public static NotificationCompat.Builder importantBuilder(Context context) {

    final NotificationCompat.Builder builder =
        baseBuilder(context, Channel.IMPORTANT)
  ...
  public static void init(Context context) {
    ...
    createNotificationChannel(context, DEFAULT_CHANNEL_ID, R.string.app_name,
  ...
  private static void
  createNotificationChannel(Context context, String channelId,
                            int channelNameRes, int importance) {
    final NotificationManager notificationManager =
        (NotificationManager)context.getSystemService(
            Context.NOTIFICATION_SERVICE);
    ...
    final NotificationChannel channel = new NotificationChannel(
        channelId, context.getString(channelNameRes), importance);
