...
public class FirstrunUpgradePagerAdapter extends PagerAdapter {
  ...
  private static class FirstrunPage {
    ...
    private FirstrunPage(String title, String content1,
                         String content1Highlight, String content2,
                         String content2Highlight) {
      this.title = title;
  ...
  public FirstrunUpgradePagerAdapter(Context context,
    ...
    pages = new FirstrunUpgradePagerAdapter.FirstrunPage[] {new FirstrunPage(
  ...
  private View getView(int position, ViewGroup container) {
    final View view = LayoutInflater.from(context).inflate(
        R.layout.firstrun_upgrade_page, container, false);
    ...
    final ForegroundColorSpan foregroundColorSpan =
        new ForegroundColorSpan(ResourcesCompat.getColor(
            context.getResources(), R.color.onboarding_text_highlight, null));

    final TextView titleView = (TextView)view.findViewById(R.id.title);
    titleView.setText(firstrunPages.title);

    final Spannable highlightSpan1 = highlightTextSpan(
        firstrunPages.content1, firstrunPages.content1Highlight, styleSpan,
        foregroundColorSpan);
    final TextView text1View = (TextView)view.findViewById(R.id.text1);
    text1View.setText(highlightSpan1);

    final Spannable highlightSpan2 = highlightTextSpan(
        firstrunPages.content2, firstrunPages.content2Highlight, styleSpan,
        foregroundColorSpan);
  ...
  @NonNull
  private Spannable highlightTextSpan(String body, String highlight,
                                      StyleSpan styleSpan,
    ...
    final SpannableStringBuilder highlightSpan =
        new SpannableStringBuilder(content);
    highlightSpan.setSpan(styleSpan, start, end,
                          Spannable.SPAN_INCLUSIVE_INCLUSIVE);
    highlightSpan.setSpan(foregroundColorSpan, start, end,
                          Spannable.SPAN_INCLUSIVE_INCLUSIVE);
