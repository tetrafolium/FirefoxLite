...
public class BrowsingHistoryFragment extends PanelFragment
    implements View.OnClickListener, ItemClosingPanelFragmentStatusListener {
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup container,
    ...
    View v =
        inflater.inflate(R.layout.fragment_browsing_history, container, false);
    v.findViewById(R.id.browsing_history_btn_clear).setOnClickListener(this);

    mContainerRecyclerView = (ViewGroup)v.findViewById(
        R.id.browsing_history_recycler_view_container);
    mContainerEmptyView = (ViewGroup)v.findViewById(R.id.empty_view_container);
    mRecyclerView =
        (RecyclerView)v.findViewById(R.id.browsing_history_recycler_view);
    return v;
  }
  ...
  public void onClick(View v) {
    ...
    case R.id.browsing_history_btn_clear:
      // if Fragment is detached but AlertDialog still on the screen, we might
      // get null context in callback
      final Context ctx = getContext();
      AlertDialog.Builder builder =
          new AlertDialog.Builder(getActivity(), R.style.AlertDialogStyle);
      builder.setTitle(R.string.browsing_history_dialog_confirm_clear_message);
      builder.setPositiveButton(
          R.string.browsing_history_dialog_btn_clear,
          new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
              ...
              ChromeViewModel chromeViewModel =
                  Inject.obtainChromeViewModel(getActivity());
