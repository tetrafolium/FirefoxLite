...
public class DownloadTest {
  ...
  @Rule
  public final GrantPermissionRule write_permissionRule =
      GrantPermissionRule.grant(Manifest.permission.WRITE_EXTERNAL_STORAGE);
  @Rule
  public final GrantPermissionRule read_permissionRule =
    ...
    protected void beforeActivityLaunched() {
      ...
      try {
        ...
        webServer.enqueue(new MockResponse().setBody(
            AndroidTestUtils.readTestAsset(IMAGE_FILE_NAME_RABBIT)));
        webServer.enqueue(new MockResponse().setBody(
   ...
   */
  @Test
  public void triggerDownload_showToast()
      throws InterruptedException, UiObjectNotFoundException, IOException {
    ...
    try {
      final File dir = StorageUtils.getTargetDirOnRemovableStorageForDownloads(
      ...
      onView(allOf(withId(R.id.title), withText(IMAGE_FILE_NAME_DOWNLOADED)))
          .check(matches(isDisplayed()));

    } catch (NoRemovableStorageException e) {
      Log.e(TAG,
            "there's no removable storage for DownloadTest so we skip this.");
    }

    // TODO: 1. Long Click and check context menu 2. Check File name after
    // downloads completed.
  }
   ...
   */
  @Test
  public void triggerDownload_FileRemoveFromList()
      throws InterruptedException, UiObjectNotFoundException, IOException {
  ...
  private void browsePageAndDownload() {
    ...
    final SessionLoadedIdlingResource sessionLoadedIdlingResource =
