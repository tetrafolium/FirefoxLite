...
public class ShareWithFriendTest {
  ...
  @Rule
  public IntentsTestRule<MainActivity> mainActivity =
  ...
  public void shareWithFriends() {
    ...
    onData(withKey(activity.getResources().getString(
               R.string.pref_key_share_with_friends)))
        .perform(click());
                       ...
                       hasExtra(Intent.EXTRA_TEXT,
                                activity.getResources().getString(
                                    ...
                                    activity.getResources().getString(
                                        R.string.app_name),
                                    activity.getResources().getString(
                                        R.string.share_app_google_play_url),
                                    activity.getResources().getString(
                                        R.string.mozilla)))))));
  }
}
