...
public class PrivateBrowsingScreenshot extends BaseScreenshot {
  ...
  @Rule
  public ActivityTestRule<PrivateModeActivity> activityTestRule =
      new ActivityTestRule<>(PrivateModeActivity.class, true, false);
  ...
  public void setUp() {
    ...
    final NotificationManager notificationManager =
        (NotificationManager)activityTestRule.getActivity().getSystemService(
  ...
  public void screenshotPrivateBrowsing() {
    ...
    // Once the new session is created, we listen when the session completes
    // loading
    ...
    MockUIUtils.showToast(activityTestRule.getActivity(),
                          R.string.private_browsing_erase_done);
    ...
    String notificationText =
        activityTestRule.getActivity().getResources().getString(
            R.string.private_browsing_erase_message);
    UiObject notificationObject =
        uiDevice.findObject(new UiSelector().text(notificationText));
