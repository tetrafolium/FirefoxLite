...
public class OnboardingScreenshot extends BaseScreenshot {
  ...
  public void screenshotOnboardingPage() {
    ...
    onView(allOf(withId(R.id.switch_widget), isDisplayed()))
    ...
    activityTestRule.getActivity().runOnUiThread(
        activityTestRule.getActivity()::showMyShotOnBoarding);

    onView(withText(R.string.my_shot_on_boarding_message))
        .inRoot(isDialog())
    ...
    onView(withText(R.string.night_mode_on_boarding_message))
        .inRoot(isDialog())
        .check(matches(isDisplayed()));
