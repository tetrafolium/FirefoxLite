...
public class DownloadScreenshot extends BaseScreenshot {
  ...
  public void setUp() {
    ...
    Screengrab.setDefaultScreenshotStrategy(
        new FalconScreenshotStrategy(activityRule.getActivity()));
    sessionLoadedIdlingResource =
        new SessionLoadedIdlingResource(activityRule.getActivity());
  }
  ...
  public void screenshotDownload() {
    ...
    MockUIUtils.showToast(activityRule.getActivity(),
                          R.string.message_removable_storage_space_not_enough);
    AndroidTestUtils.toastContainsText(
    ...
    // event at the center of image Long click on image with popup context menu
    ...
    downloadCompleteIdlingResource =
        new DownloadCompleteIdlingResource(activityRule.getActivity());
    ...
    onView(allOf(withId(com.google.android.material.R.id.snackbar_text),
                 withText(containsString(IMAGE_FILE_NAME_DOWNLOADED_PREFIX))))
        .check(matches(isDisplayed()));
    ...
    onView(withId(R.id.recyclerview))
        .perform(RecyclerViewActions.actionOnItemAtPosition(
            0, clickChildViewWithId(R.id.menu_action)));
