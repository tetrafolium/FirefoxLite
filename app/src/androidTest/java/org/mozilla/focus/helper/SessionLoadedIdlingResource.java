...
/**
 * An IdlingResource implementation that waits until the BrowserFragment is not
 * loading anymore. Only after loading has completed further actions will be
 * performed.
 */
public class SessionLoadedIdlingResource implements IdlingResource {
  ...
  class Observer implements SessionManager.Observer, Session.Observer {
    ...
    @Override
    public void onLoadingStateChanged(@NotNull Session session,
                                      boolean loading) {
      isCompleted = !loading;
      if (isCompleted) {
        invokeCallback();
    ...
    @Override
    public void onTitleChanged(@NotNull Session session,
    ...
    @Override
    public void onLongPress(@NotNull Session session,
                            @NotNull TabView.HitTarget hitTarget) {}

    @Override
    public boolean onDownload(@NotNull Session session,
    ...
    @Override
    public void onEnterFullScreen(@NotNull TabView.FullscreenCallback callback,
                                  @Nullable View view) {}
    ...
    @Override
    public void onFocusChanged(@Nullable Session session,
                               @NotNull SessionManager.Factor factor) {}
