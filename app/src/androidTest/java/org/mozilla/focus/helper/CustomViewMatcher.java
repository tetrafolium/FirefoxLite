...
/**
 * CustomViewMatcher is a help class to collect all customize view matchers
 * that Espresso doesn't support *
 */
public class CustomViewMatcher {

  public static Matcher<View> isActivate() { return new IsActivateMatcher(); }
