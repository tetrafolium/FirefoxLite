...
public class ActivityRecreateLeakWatcherIdlingResource
    implements IdlingResource, Application.ActivityLifecycleCallbacks {
  ...
  public boolean hasLeak() { return hasLeak.get(); }
  ...
  public void onActivityCreated(Activity activity, Bundle savedInstanceState) {
    if (LeakWatcher.getReference() != null &&
        LeakWatcher.getReference().get() != null) {
      LeakWatcher.runGc();
