...
public class FocusStringTest {
  ...
  @Test(expected = StringIndexOutOfBoundsException.class)
  public void outofBoundsAfterSubstring()
  ...
  @Test(expected = StringIndexOutOfBoundsException.class)
  public void outofBoundsAfterSubstringEmpty()
      throws StringIndexOutOfBoundsException {
    final String fullStringRaw = "abcd";
    final FocusString fullString = FocusString.create(fullStringRaw);
  ...
  public void testReverseString() {
    ...
    final String fullStringRaw =
        new StringBuffer(fullUnreversedStringRaw).reverse().toString();
    final FocusString fullString =
        FocusString.create(fullUnreversedStringRaw).reverse();
