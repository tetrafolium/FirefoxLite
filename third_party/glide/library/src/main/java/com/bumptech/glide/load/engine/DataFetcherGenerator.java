...
/**
 * Generates a series of {@link com.bumptech.glide.load.data.DataFetcher
 * DataFetchers} using registered {@link
 * com.bumptech.glide.load.model.ModelLoader ModelLoaders} and a model.
 */
interface DataFetcherGenerator {
  ...
  interface FetcherReadyCallback {
     ...
     * @param attemptedKey The key we were loading data from (may be an
     *     alternate).
     */
  ...
  /**
   * Attempts to a single new {@link com.bumptech.glide.load.data.DataFetcher}
   * and returns true if a {@link com.bumptech.glide.load.data.DataFetcher} was
