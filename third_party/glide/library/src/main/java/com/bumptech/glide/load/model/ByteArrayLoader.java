 ...
 * This class is abstract because there is no simple/quick way to generate an id
 * from the bytes themselves, so subclass must include an id.
 *
...
public class ByteArrayLoader<Data> implements ModelLoader<byte[], Data> {
  ...
  public LoadData<Data> buildLoadData(byte[] model, int width, int height,
    ...
    return new LoadData<>(EmptySignature.obtain(),
                          new Fetcher<>(model, converter));
  }
  ...
  public static class ByteBufferFactory
    ...
    @Override
    public ModelLoader<byte[], ByteBuffer>
  ...
  public static class StreamFactory
    ...
    @Override
    public ModelLoader<byte[], InputStream>
    build(MultiModelLoaderFactory multiFactory) {
