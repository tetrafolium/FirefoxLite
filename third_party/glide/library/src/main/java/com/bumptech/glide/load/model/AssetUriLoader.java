...
public class AssetUriLoader<Data> implements ModelLoader<Uri, Data> {
  ...
  public AssetUriLoader(AssetManager assetManager,
                        AssetFetcherFactory<Data> factory) {
  ...
  public LoadData<Data> buildLoadData(Uri model, int width, int height,
    ...
    return new LoadData<>(new ObjectKey(model),
                          factory.buildFetcher(assetManager, assetPath));
  }
  ...
  public static class StreamFactory
    ...
    @Override
    public DataFetcher<InputStream> buildFetcher(AssetManager assetManager,
                                                 String assetPath) {
  ...
  public static class FileDescriptorFactory
    ...
    @Override
    public DataFetcher<ParcelFileDescriptor>
    buildFetcher(AssetManager assetManager, String assetPath) {
