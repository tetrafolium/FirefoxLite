...
public abstract class DiskCacheStrategy {
  ...
  /**
   * Caches remote data with both {@link #DATA} and {@link #RESOURCE}, and local
   * data with
   * {@link #RESOURCE} only.
   */
  ...
  public static final DiskCacheStrategy AUTOMATIC = new DiskCacheStrategy() {
    ...
    public boolean isResourceCacheable(boolean isFromAlternateCacheKey,
                                       DataSource dataSource,
                                       EncodeStrategy encodeStrategy) {
      return ((isFromAlternateCacheKey &&
   ...
   *
   * @param isFromAlternateCacheKey {@code true} if the resource we've decoded
   *     was loaded using an
   *                                alternative, rather than the primary, cache
   * key.
   * @param dataSource Indicates where the data used to decode the resource was
   *     originally
   *                   retrieved.
