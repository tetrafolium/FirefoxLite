...
/**
 * A unique signature based on metadata data from the media store that detects
 * common changes to media store files like edits, rotations, and temporary file
 * replacement.
 */
public class MediaStoreSignature implements Key {
   ...
   *
   * @param mimeType     The mime type of the media store media. Ok to default
   *     to empty string "".
   *                     See {@link
   * android.provider.MediaStore.Images.ImageColumns#MIME_TYPE} or
   *                     {@link
   * android.provider.MediaStore.Video.VideoColumns#MIME_TYPE}.
   * @param dateModified The date modified time of the media store media. Ok to
   *     default to 0. See
   *                     {@link
   * android.provider.MediaStore.Images.ImageColumns#DATE_MODIFIED} or
   *                     {@link
   * android.provider.MediaStore.Video.VideoColumns#DATE_MODIFIED}.
   * @param orientation  The orientation of the media store media. Ok to default
   *     to 0. See {@link
   *                     android.provider.MediaStore.Images.ImageColumns#ORIENTATION}.
   */
  public MediaStoreSignature(String mimeType, long dateModified,
                             int orientation) {
