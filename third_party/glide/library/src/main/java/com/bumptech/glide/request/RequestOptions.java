...
public class RequestOptions implements Cloneable {
  ...
  /**
   * Returns a {@link RequestOptions} object with {@link #sizeMultiplier(float)}
   * set.
   */
  ...
  /**
   * Returns a {@link RequestOptions} object with {@link
   * #diskCacheStrategy(DiskCacheStrategy)} set.
   */
  @CheckResult
  public static RequestOptions
  diskCacheStrategyOf(@NonNull DiskCacheStrategy diskCacheStrategy) {
    return new RequestOptions().diskCacheStrategy(diskCacheStrategy);
  }

  /**
   * Returns a {@link RequestOptions} object with {@link #priority(Priority)}}
   * set.
   */
  @SuppressWarnings("WeakerAccess") // Public API
  @CheckResult
  ...
  /**
   * Returns a {@link RequestOptions} object with {@link #placeholder(Drawable)}
   * set.
   */
  @CheckResult
    ...
    if (skipMemoryCache) {
      if (skipMemoryCacheTrueOptions == null) {
        skipMemoryCacheTrueOptions =
            new RequestOptions().skipMemoryCache(true).autoClone();
      }
      return skipMemoryCacheTrueOptions;
    } else {
      if (skipMemoryCacheFalseOptions == null) {
        skipMemoryCacheFalseOptions =
            new RequestOptions().skipMemoryCache(false).autoClone();
      }
  ...
  /**
   * Returns a {@link RequestOptions} object with {@link #override(int, int)}}
   * set.
   */
  @SuppressWarnings("WeakerAccess") // Public API
  @CheckResult
  ...
  /**
   * Returns a {@link RequestOptions} with {@link #override(int, int)} set where
   * both the width and height are the given size.
   */
  @SuppressWarnings("WeakerAccess") // Public API
  @CheckResult
  ...
  /**
   * Returns a {@link RequestOptions} object with {@link
   * #transform(Transformation)} set.
   */
  @SuppressWarnings("WeakerAccess") // Public API
  @CheckResult
  public static RequestOptions
  bitmapTransform(@NonNull Transformation<Bitmap> transformation) {
  ...
  /**
   * Returns a {@link RequestOptions} object with the given {@link Option} set
   * via
   * {@link #set(Option, Object)}.
   */
  @CheckResult
  public static <T> RequestOptions option(@NonNull Option<T> option,
                                          @NonNull T value) {
  ...
  /**
   * Returns a {@link RequestOptions} object with {@link #format(DecodeFormat)}
   * set.
   */
  @SuppressWarnings("WeakerAccess") // Public API
  @CheckResult
  ...
  /**
   * Returns a {@link RequestOptions} object with {@link
   * #downsample(DownsampleStrategy)} set.
   */
  @SuppressWarnings("WeakerAccess") // Public API
  @CheckResult
  public static RequestOptions
  downsampleOf(@NonNull DownsampleStrategy strategy) {
  ...
  /**
   * Returns a {@link com.bumptech.glide.request.RequestOptions} with {@link
   * #encodeFormat(android.graphics.Bitmap.CompressFormat)} called with the
   * given format.
   */
  @SuppressWarnings("WeakerAccess") // Public API
  @CheckResult
  public static RequestOptions
  encodeFormatOf(@NonNull Bitmap.CompressFormat format) {
  ...
  /**
   * Applies a multiplier to the {@link
   * com.bumptech.glide.request.target.Target}'s size before loading the
   * resource. Useful for loading thumbnails or trying to avoid loading huge
   * resources (particularly {@link Bitmap}s on devices with overly dense
   * screens.
   *
   * @param sizeMultiplier The multiplier to apply to the
   *                       {@link com.bumptech.glide.request.target.Target}'s
  ...
  /**
   * If set to true, will only load an item if found in the cache, and will not
   * fetch from source.
   */
  @CheckResult
   ...
   * ideal. Applications that use the same resource multiple times in multiple
   * sizes and are willing to trade off some speed and disk space in return for
   * lower bandwidth usage may want to consider using {@link
   * DiskCacheStrategy#DATA} or
   ...
   *
   * <p> If a fallback is not set, null models will cause the error drawable to
   * be displayed. If the error drawable is not set, the placeholder will be
   * displayed.
   *
  ...
  /**
   * Sets the {@link android.content.res.Resources.Theme} to apply when loading
   * {@link Drawable}s for resource ids provided via {@link #error(int)}, {@link
   * #placeholder(int)}, and
   ...
   *
   * <p> Note - this is not a guarantee. If a request is already pending for
   * this resource and that request is not also skipping the memory cache, the
   * resource will be cached in memory.</p>
   *
  ...
  /**
   * Overrides the {@link com.bumptech.glide.request.target.Target}'s width and
   * height with the given values. This is useful for thumbnails, and should
   * only be used for other cases when you need a very specific image size.
   *
  ...
  /**
   * Sets some additional data to be mixed in to the memory and disk cache keys
   * allowing the caller more control over when cached data is invalidated.
   *
   * <p> Note - The signature does not replace the cache key, it is purely
   * additive. </p>
   *
   ...
   *
   * <p> Even if this object was locked, the cloned object returned from this
   * method will not be locked. </p>
   */
  ...
  public final boolean isTransformationSet() { return isSet(TRANSFORMATION); }
  ...
  public RequestOptions encodeFormat(@NonNull Bitmap.CompressFormat format) {
    return set(BitmapEncoder.COMPRESSION_FORMAT,
   ...
   *
   * <p>This is a component option specific to {@link VideoBitmapDecoder}. If
   * the default video decoder is replaced or skipped because of your
   * configuration, this option may be ignored.
   *
   * @see VideoBitmapDecoder#TARGET_FRAME
   * @param frameTimeMicros The time position in microseconds of the desired
   *     frame. If negative, the
   *                        Android framework implementation return a
  ...
  /**
   * Sets the {@link DecodeFormat} to use when decoding {@link Bitmap} objects
   * using
   * {@link Downsampler}.
   *
   * <p>{@link DecodeFormat} is a request, not a requirement. It's possible the
   * resource will be decoded using a decoder that cannot control the format
   * ({@link android.media.MediaMetadataRetriever} for example), or that the
   * decoder may choose to ignore the requested format if it can't display the
   * image (i.e. RGB_565 is requested, but the image has alpha).
   *
   * <p>This is a component option specific to {@link Downsampler}. If the
   * defautlt Bitmap decoder is replaced or skipped because of your
   * configuration, this option may be ignored.
   *
  ...
  /**
   * Sets the {@link DownsampleStrategy} to use when decoding {@link Bitmap
   * Bitmaps} using
   * {@link Downsampler}.
   *
   * <p>This is a component option specific to {@link Downsampler}. If the
  ...
  public RequestOptions downsample(@NonNull DownsampleStrategy strategy) {
    return set(Downsampler.DOWNSAMPLE_STRATEGY,
               Preconditions.checkNotNull(strategy));
  }

  /**
   * Sets the read and write timeout for the http requests used to load the
   * image.
   *
   * <p>This is a component option specific to Glide's default networking
   * library and
   * {@link com.bumptech.glide.load.model.stream.HttpGlideUrlLoader}. If you use
   * any other networking library including Glide's Volley or OkHttp integration
   * libraries, this option will be ignored.
   *
  ...
  /**
   * Applies {@link com.bumptech.glide.load.resource.bitmap.CenterCrop} to all
   * default types, and ignores unknown types.
   *
  ...
  public RequestOptions optionalCenterCrop() {
    return optionalTransform(DownsampleStrategy.CENTER_OUTSIDE,
                             new CenterCrop());
  }
  ...
  /**
   *
   * Applies {@link FitCenter} and to all default types, {@link
   * DownsampleStrategy#FIT_CENTER} to image types, and ignores unknown types.
   *
   * <p>This will override previous calls to {@link #dontTransform()} and
   * previous calls to
  ...
  public RequestOptions optionalFitCenter() {
    return optionalScaleOnlyTransform(DownsampleStrategy.FIT_CENTER,
                                      new FitCenter());
  }

  /**
   * Applies {@link FitCenter} and to all default types, {@link
   * DownsampleStrategy#FIT_CENTER} to image types, and throws an exception if
  ...
  /**
   * Applies {@link com.bumptech.glide.load.resource.bitmap.CenterInside} to all
   * default types,
   * {@link DownsampleStrategy#CENTER_INSIDE} to image types, and ignores
   * unknown types.
   *
   * <p>This will override previous calls to {@link #dontTransform()} and
   * previous calls to
  ...
  public RequestOptions optionalCenterInside() {
    return optionalScaleOnlyTransform(DownsampleStrategy.CENTER_INSIDE,
                                      new CenterInside());
  }

  /**
   * Applies {@link CenterInside} to all default types, {@link
   * DownsampleStrategy#CENTER_INSIDE} to image types and throws an exception if
   * asked to transform an unknown type.
   *
   * <p>This will override previous calls to {@link #dontTransform()} and
   * previous calls to
  ...
  public RequestOptions centerInside() {
    return scaleOnlyTransform(DownsampleStrategy.CENTER_INSIDE,
                              new CenterInside());
  }
  ...
  /**
   * Applies {@link CircleCrop} to all default types and throws an exception if
   * asked to transform an unknown type.
   *
   * <p>This will override previous calls to {@link #dontTransform()}.
   *
  ...
  // calling optionalTransform() on the result of clone() requires greater
  // access. calling downsample is guaranteed to modify the current object by
  // the isAutoCloneEnabledCheck.
  @SuppressWarnings({"WeakerAccess", "CheckResult"})
  final RequestOptions
  optionalTransform(DownsampleStrategy downsampleStrategy,
  ...
  // calling downsample is guaranteed to modify the current object by the
  // isAutoCloneEnabledCheck.
  @SuppressWarnings({"WeakerAccess", "CheckResult"})
  @CheckResult
  ...
  scaleOnlyTransform(DownsampleStrategy strategy,
                     Transformation<Bitmap> transformation) {
    return scaleOnlyTransform(strategy, transformation,
                              true /*isTransformationRequired*/);
  }

  private RequestOptions
  optionalScaleOnlyTransform(DownsampleStrategy strategy,
                             Transformation<Bitmap> transformation) {
    return scaleOnlyTransform(strategy, transformation,
  ...
  transform(@NonNull Transformation<Bitmap> transformation) {
    if (isAutoCloneEnabled) {
   ...
   * <p>This will override previous calls to {@link #dontTransform()}.
   *
   * @param transformations One or more {@link Transformation}s for {@link
   *     Bitmap}s.
   * @see #optionalTransform(Transformation)
   * @see #optionalTransform(Class, Transformation)
   */
  ...
  @CheckResult
  public RequestOptions
  transforms(@NonNull Transformation<Bitmap>... transformations) {
    if (isAutoCloneEnabled) {
   ...
   * Applies the given {@link Transformation} for
   * {@link Bitmap Bitmaps} to the default types ({@link Bitmap},
   * {@link android.graphics.drawable.BitmapDrawable}, and ignores unknown
   * types.
   *
   * <p>This will override previous calls to {@link #dontTransform()}.
   *
   ...
   *
   * <p> Users can apply different transformations for each resource class.
   * Applying a
   * {@link Transformation} for a resource type that already has a
   * {@link Transformation} will override the previous call. </p>
   *
   * <p> If any calls are made to the non-optional transform methods, then
   * attempting to transform an unknown resource class will throw an exception.
   * To allow unknown types, users must always call the optional version of each
   * method. </p>
   *
   * <p>This will override previous calls to {@link #dontTransform()}.
   *
   ...
   */
  @CheckResult
  public <T> RequestOptions
  optionalTransform(Class<T> resourceClass, Transformation<T> transformation) {
    if (isAutoCloneEnabled) {
    ...
    // Always set to false here. Known scale only transformations will call this
    // method and then set isScaleOnlyOrNoTransform to true immediately after.
  ...
  @SuppressWarnings("CheckResult")
  @CheckResult
  public <T> RequestOptions transform(Class<T> resourceClass,
   ...
   * resource classes and allows unknown resource types to be transformed
  ...
  /**
   * Disables resource decoders that return animated resources so any resource
  ...
  public RequestOptions apply(RequestOptions other) {
    ...
    // Applying options with dontTransform() is expected to clear our
    // transformations.
  ...
  public boolean equals(Object o) {
    if (o instanceof RequestOptions) {
      ...
      return Float.compare(other.sizeMultiplier, sizeMultiplier) == 0 &&
          ...
          placeholderId == other.placeholderId &&
          Util.bothNullOrEqual(placeholderDrawable,
                               other.placeholderDrawable) &&
          fallbackId == other.fallbackId &&
          ...
          useUnlimitedSourceGeneratorsPool ==
              other.useUnlimitedSourceGeneratorsPool &&
          onlyRetrieveFromCache == other.onlyRetrieveFromCache &&
          diskCacheStrategy.equals(other.diskCacheStrategy) &&
          priority == other.priority && options.equals(other.options) &&
  ...
  /**
   * Similar to {@link #lock()} except that mutations cause a {@link #clone()}
   * operation to happen before the mutation resulting in all methods returning
   * a new Object and leaving the original locked object unmodified.
   *
   * <p>Auto clone is not retained by cloned objects returned from mutations.
   * The cloned objects are mutable and are not locked.
   */
  public RequestOptions autoClone() {
    if (isLocked && !isAutoCloneEnabled) {
      throw new IllegalStateException(
          "You cannot auto lock an already locked options object"
          + ", try clone() first");
    }
  ...
  private RequestOptions selfOrThrowIfLocked() {
    if (isLocked) {
      throw new IllegalStateException(
          "You cannot modify locked RequestOptions, consider clone()");
    }
    return this;
  }

  protected boolean isAutoCloneEnabled() { return isAutoCloneEnabled; }
  ...
  public final boolean isPrioritySet() { return isSet(PRIORITY); }
  ...
  public final int getOverrideWidth() { return overrideWidth; }

  public final boolean isValidOverride() {
    return Util.isValidDimensions(overrideWidth, overrideHeight);
  }

  public final int getOverrideHeight() { return overrideHeight; }

  public final float getSizeMultiplier() { return sizeMultiplier; }

  public boolean isScaleOnlyOrNoTransform() { return isScaleOnlyOrNoTransform; }

  private boolean isSet(int flag) { return isSet(fields, flag); }
