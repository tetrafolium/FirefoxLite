...
/**
 * A base {@link Target} for loading {@link
 * com.bumptech.glide.load.engine.Resource}s that provides basic or empty
 * implementations for most methods.
 *
 * <p> For maximum efficiency, clear this target when you have finished using or
 * displaying the
 * {@link com.bumptech.glide.load.engine.Resource} loaded into it using
 * {@link com.bumptech.glide.RequestManager#clear(Target)}.</p>
 *
 * <p> For loading {@link com.bumptech.glide.load.engine.Resource}s into {@link
 * android.view.View}s,
