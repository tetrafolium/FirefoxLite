...
/**
 * Scales the image uniformly (maintaining the image's aspect ratio) so that one
 * of the dimensions of the image will be equal to the given dimension and the
 * other will be less than the given dimension.
 */
public class FitCenter extends BitmapTransformation {
  ...
  protected Bitmap transform(@NonNull BitmapPool pool,
                             ...
                             int outHeight) {
    return TransformationUtils.fitCenter(pool, toTransform, outWidth,
                                         outHeight);
  }
