...
/**
 * A model loader for handling Android resource files. Model must be an Android
 * resource id in the package of the given context.
 *
 * @param <Data> The type of data that will be loaded for the given android
 *     resource.
 */
public class ResourceLoader<Data> implements ModelLoader<Integer, Data> {
  ...
  public static class StreamFactory
    ...
    public StreamFactory(Resources resources) { this.resources = resources; }

    @Override
    public ModelLoader<Integer, InputStream>
    build(MultiModelLoaderFactory multiFactory) {
      return new ResourceLoader<>(
          resources, multiFactory.build(Uri.class, InputStream.class));
    }
  ...
  /**
   * Factory for loading {@link ParcelFileDescriptor}s from Android resource
   * ids.
   */
  public static class FileDescriptorFactory
    ...
    @Override
    public ModelLoader<Integer, ParcelFileDescriptor>
    build(MultiModelLoaderFactory multiFactory) {
      return new ResourceLoader<>(
