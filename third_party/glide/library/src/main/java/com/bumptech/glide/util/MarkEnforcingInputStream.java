...
/**
 * Prevents {@link InputStream InputStreams} from overflowing their buffer by
 * reading data past their read limit.
 */
public class MarkEnforcingInputStream extends FilterInputStream {
  ...
  public MarkEnforcingInputStream(InputStream in) { super(in); }
