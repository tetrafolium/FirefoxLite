...
public final class RoundedCorners extends BitmapTransformation {
   ...
   */
  @Deprecated
  public RoundedCorners(@SuppressWarnings("unused") BitmapPool bitmapPool,
                        int roundingRadius) {
    this(roundingRadius);
  }
   ...
   */
  @Deprecated
  public RoundedCorners(@SuppressWarnings("unused") Context context,
                        int roundingRadius) {
    this(roundingRadius);
  }
  ...
  protected Bitmap transform(@NonNull BitmapPool pool,
                             ...
                             int outHeight) {
    return TransformationUtils.roundedCorners(pool, toTransform, outWidth,
  ...
  public boolean equals(Object o) {
    return (o instanceof RoundedCorners) &&
        ((RoundedCorners)o).roundingRadius == roundingRadius;
  }
