...
/**
 * A utility class for obtaining a {@link com.bumptech.glide.load.Key} signature
 * containing the application version name using {@link
...
public final class ApplicationVersionSignature {
  ...
  /**
   * Returns the signature {@link com.bumptech.glide.load.Key} for version code
   * of the Application of the given Context.
   */
