...
public class ViewAnimationFactory<R> implements TransitionFactory<R> {
  ...
  ViewAnimationFactory(ViewTransition.ViewTransitionAnimationFactory
   ...
   * isFromMemoryCache is {@code true} or isFirstImage is {@code false}, returns
   * a {@link NoTransition} and otherwise returns a new
   * {@link ViewTransition}.
   *
