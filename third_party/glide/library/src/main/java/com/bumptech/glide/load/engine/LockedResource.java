...
/**
 * A resource that defers any calls to {@link Resource#recycle()} until after
 * {@link #unlock()} is called.
 *
 * <p>If the resource was recycled prior to {@link #unlock()}, then {@link
 * #unlock()} will also recycle the resource.
 */
final class LockedResource<Z> implements Resource<Z>, FactoryPools.Poolable {
  private static final Pools.Pool<LockedResource<?>> POOL =
      FactoryPools.threadSafe(20,
