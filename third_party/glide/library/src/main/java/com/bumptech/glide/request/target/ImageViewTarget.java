 ...
 * resources in {@link android.widget.ImageView}s.
 *
...
public abstract class ImageViewTarget<Z>
    extends ViewTarget<ImageView, Z> implements Transition.ViewAdapter {
   ...
   * displayed in the view using {@link android.widget.ImageView#getDrawable()}.
   */
  @Override
  @Nullable
