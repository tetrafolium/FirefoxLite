...
/**
 * A put of helper classes that performs no loading and instead always returns
 * the given model as the data to decode.
 *
 * @param <Model> The type of model that will also be returned as decodable
 *     data.
 */
public class UnitModelLoader<Model> implements ModelLoader<Model, Model> {
  ...
  private static class UnitFetcher<Model> implements DataFetcher<Model> {
    ...
    public UnitFetcher(Model resource) { this.resource = resource; }
  ...
  /**
   * Factory for producing {@link
   * com.bumptech.glide.load.model.UnitModelLoader}s.
   *
   * @param <Model> The type of model that will also be returned as decodable
   *     data.
   */
