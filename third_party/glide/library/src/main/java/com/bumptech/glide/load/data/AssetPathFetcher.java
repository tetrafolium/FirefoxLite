 ...
 *
 * @param <T> The type of data obtained from the asset path (InputStream,
 *     FileDescriptor etc).
 */
public abstract class AssetPathFetcher<T> implements DataFetcher<T> {
  ...
  /**
   * Opens the given asset path with the given {@link
   * android.content.res.AssetManager} and returns the concrete data type
   * returned by the AssetManager.
   *
   ...
   */
  protected abstract T loadResource(AssetManager assetManager, String path)
      throws IOException;
