 ...
 *
 * <p>See http://www.ietf.org/rfc/rfc2397.txt  for a complete description of the
 * 'data' URL scheme.
 *
...
public final class DataUrlLoader<Data> implements ModelLoader<String, Data> {
  ...
  public LoadData<Data> buildLoadData(String model, int width, int height,
    ...
    return new LoadData<>(new ObjectKey(model),
                          new DataUriFetcher<Data>(model, dataDecoder));
  }
  ...
  public static final class StreamFactory
    ...
    @Override
    public final ModelLoader<String, InputStream>
