 ...
 * com.bumptech.glide.RequestManager} that can be used to start, stop and manage
 * Glide requests started for targets the fragment or activity this fragment is
 * a child of.
 *
...
public class RequestManagerFragment extends Fragment {
  ...
  public Set<RequestManagerFragment> getDescendantRequestManagerFragments() {
    if (rootRequestManagerFragment == this) {
      ...
      // Pre JB MR1 doesn't allow us to get the parent fragment so we can't
      // introspect hierarchy, so just return an empty set.
  ...
  private class FragmentRequestManagerTreeNode
    ...
    public Set<RequestManager> getDescendants() {
      Set<RequestManagerFragment> descendantFragments =
