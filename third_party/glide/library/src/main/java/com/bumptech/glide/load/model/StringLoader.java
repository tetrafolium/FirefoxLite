...
/**
 * A model loader for handling certain string models. Handles paths, urls, and
 * any uri string with a scheme handled by {@link
 * android.content.ContentResolver#openInputStream(Uri)}.
 *
 * @param <Data> The type of data that will be loaded from the given {@link
 *     java.lang.String}.
 */
public class StringLoader<Data> implements ModelLoader<String, Data> {
  ...
  public static class StreamFactory
    ...
    @Override
    public ModelLoader<String, InputStream>
  ...
  public static class FileDescriptorFactory
    ...
    @Override
    public ModelLoader<String, ParcelFileDescriptor>
    build(MultiModelLoaderFactory multiFactory) {
      return new StringLoader<>(
