 ...
 * {@link com.bumptech.glide.RequestManager} that can be used to start, stop and
 * manage Glide requests started for targets within the fragment or activity
...
public class SupportRequestManagerFragment extends Fragment {
  ...
  private final HashSet<SupportRequestManagerFragment>
  ...
  ActivityFragmentLifecycle getGlideLifecycle() { return lifecycle; }

  /**
   * Returns the current {@link com.bumptech.glide.RequestManager} or null if
   * none is put.
   */
  @Nullable
  ...
  /**
   * Returns the {@link RequestManagerTreeNode} that provides tree traversal
   * methods relative to the associated {@link RequestManager}.
   */
  ...
  private void
  addChildRequestManagerFragment(SupportRequestManagerFragment child) {
    childRequestManagerFragments.add(child);
  }

  private void
  removeChildRequestManagerFragment(SupportRequestManagerFragment child) {
    childRequestManagerFragments.remove(child);
  }

  /**
   * Returns the set of fragments that this RequestManagerFragment's parent is a
   * parent to. (i.e. our parent is the fragment that we are annotating).
   */
  public Set<SupportRequestManagerFragment>
  ...
  /**
   * Sets a hint for which fragment is our parent which allows the fragment to
   * return correct information about its parents before pending fragment
   * transactions have been executed.
   */
  void setParentFragmentHint(Fragment parentFragmentHint) {
    this.parentFragmentHint = parentFragmentHint;
    if (parentFragmentHint != null &&
        parentFragmentHint.getActivity() != null) {
  ...
  private class SupportFragmentRequestManagerTreeNode
    ...
    public String toString() {
      return super.toString() +
          "{fragment=" + SupportRequestManagerFragment.this + "}";
    }
  }
}
