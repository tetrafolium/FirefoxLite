...
public final class BitmapTransitionOptions
  ...
  /**
   * Returns a {@link BitmapTransitionOptions} object that enables a cross fade
   * animation.
   *
   * @see #crossFade()
   */
   ...
   */
  public static BitmapTransitionOptions
  ...
  /**
   * Returns a {@link BitmapTransitionOptions} object that enables a any
   * animation that is possible on drawables.
   *
   * @see #transitionUsing(TransitionFactory)
   */
  public static BitmapTransitionOptions
  withWrapped(TransitionFactory<Drawable> drawableCrossFadeFactory) {
    return new BitmapTransitionOptions().transitionUsing(
        drawableCrossFadeFactory);
  }

  /**
   * Returns a {@link BitmapTransitionOptions} object that uses the given
   * transition factory.
   *
  ...
  /**
   * Enables a cross fade animation between both the placeholder and the first
   * resource and between subsequent resources (if thumbnails are used).
   */
