...
/**
 * Contains an ordered list of {@link ResourceEncoder}s capable of encoding
...
public class ResourceEncoderRegistry {
  ...
  public synchronized<Z> void append(Class<Z> resourceClass,
                                     ResourceEncoder<Z> encoder) {
    encoders.add(new Entry<>(resourceClass, encoder));
  }

  public synchronized<Z> void prepend(Class<Z> resourceClass,
                                      ResourceEncoder<Z> encoder) {
