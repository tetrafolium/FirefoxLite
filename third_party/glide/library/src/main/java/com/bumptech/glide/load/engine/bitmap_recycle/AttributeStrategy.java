...
/**
 * A strategy for reusing bitmaps that requires any returned bitmap's dimensions
 * to exactly match those request.
 */
class AttributeStrategy implements LruPoolStrategy {
  ...
  public void put(Bitmap bitmap) {
    final Key key =
        keyPool.get(bitmap.getWidth(), bitmap.getHeight(), bitmap.getConfig());
  ...
  private static String getBitmapString(Bitmap bitmap) {
    return getBitmapString(bitmap.getWidth(), bitmap.getHeight(),
                           bitmap.getConfig());
  }
