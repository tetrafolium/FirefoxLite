 ...
 * com.bumptech.glide.manager.ConnectivityMonitor} if the application has the
 * {@code android.permission.ACCESS_NETWORK_STATE} permission and a no-op non
 * functional {@link com.bumptech.glide.manager.ConnectivityMonitor} if the app
...
public class DefaultConnectivityMonitorFactory
  ...
  build(@NonNull Context context,
    ...
    int permissionResult =
        ContextCompat.checkSelfPermission(context, NETWORK_PERMISSION);
