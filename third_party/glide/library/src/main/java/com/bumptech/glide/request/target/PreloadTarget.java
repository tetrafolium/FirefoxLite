...
/**
 * A one time use {@link com.bumptech.glide.request.target.Target} class that
 * loads a resource into memory and then clears itself.
 *
...
public final class PreloadTarget<Z> extends SimpleTarget<Z> {
  ...
  private void clear() { requestManager.clear(this); }
}
