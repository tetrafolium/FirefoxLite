...
/**
 * An {@link com.bumptech.glide.load.resource.transcode.ResourceTranscoder} that
 * converts {@link android.graphics.Bitmap}s into {@link
 * android.graphics.drawable.BitmapDrawable}s.
 */
public class BitmapDrawableTranscoder
  ...
  public Resource<BitmapDrawable> transcode(Resource<Bitmap> toTranscode,
                                            Options options) {
    return LazyBitmapDrawableResource.obtain(resources, bitmapPool,
                                             toTranscode.get());
  }
}
