...
/**
 * A cache key for downsampled and transformed resource data + any requested
 * signature.
 */
final class ResourceCacheKey implements Key {
  ...
  public ResourceCacheKey(Key sourceKey, Key signature, int width, int height,
                          ...
                          Class<?> decodedResourceClass, Options options) {
  ...
  public boolean equals(Object o) {
    if (o instanceof ResourceCacheKey) {
      ...
      return height == other.height && width == other.width &&
          ...
          signature.equals(other.signature) && options.equals(other.options);
    }
    return false;
  }
  ...
  public String toString() {
    return "ResourceCacheKey{"
        ...
        ", transformation='" + transformation + '\'' + ", options=" + options +
        '}';
  }
}
