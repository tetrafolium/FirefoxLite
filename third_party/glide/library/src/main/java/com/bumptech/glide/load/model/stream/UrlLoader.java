 ...
 * com.bumptech.glide.load.model.GlideUrl} objects and then uses the wrapped
 * {@link com.bumptech.glide.load.model.ModelLoader} for {@link
 * com.bumptech.glide.load.model.GlideUrl}s to load the data.
 */
public class UrlLoader implements ModelLoader<URL, InputStream> {
  ...
  public LoadData<InputStream> buildLoadData(URL model, int width, int height,
                                             Options options) {
    return glideUrlLoader.buildLoadData(new GlideUrl(model), width, height,
                                        options);
  }
  ...
  public static class StreamFactory
    ...
    @Override
    public ModelLoader<URL, InputStream>
