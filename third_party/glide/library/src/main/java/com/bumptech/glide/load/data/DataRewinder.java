...
public interface DataRewinder<T> {
   ...
   *
   * @param <T> The type of data that the {@link
   *     com.bumptech.glide.load.data.DataRewinder} will
   *            wrap.
   */
  interface Factory<T> {
    /**
     * Returns a new {@link com.bumptech.glide.load.data.DataRewinder} wrapping
     * the given data.
     */
  ...
  /**
   * Rewinds the wrapped data back to the position it was at when this object
   * was instantiated and returns the re-wound data (or a wrapper for the
   * re-wound data).
   *
   ...
   *
   * <p> The underlying data may still be in use and should not be closed or
   * invalidated. </p>
   */
  void cleanup();
}
