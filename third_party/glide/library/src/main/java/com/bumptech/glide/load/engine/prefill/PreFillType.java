 ...
 * {@link com.bumptech.glide.load.engine.bitmap_recycle.BitmapPool} with {@link
 * Bitmap Bitmaps} of a single size and configuration.
 */
public final class PreFillType {
   ...
   *
   * @param width  The width in pixels of the {@link android.graphics.Bitmap
   *     Bitmaps} to pre-fill.
   * @param height The height in pixels of the {@link android.graphics.Bitmap
   *     Bitmaps} to pre-fill.
   * @param config The {@link android.graphics.Bitmap.Config} of the
   *               {@link android.graphics.Bitmap Bitmaps} to pre-fill.
   * @param weight An integer indicating how to balance pre-filling this size
   *     and configuration of
   *               {@link android.graphics.Bitmap} against any other
   * sizes/configurations that may be being pre-filled.
   */
  ...
  /**
   * Returns the height in pixels of the {@link android.graphics.Bitmap
   * Bitmaps}.
   */
   ...
   */
  Bitmap.Config getConfig() { return config; }

  /**
   * Returns the weight of the {@link android.graphics.Bitmap Bitmaps} of this
   * type.
   */
  ...
  public boolean equals(Object o) {
    if (o instanceof PreFillType) {
      ...
      return height == other.height && width == other.width &&
          weight == other.weight && config == other.config;
    }
    return false;
  }
  ...
  public static class Builder {
    ...
    /**
     * Constructor for a builder that uses the given size as the width and
     * height of the Bitmaps to prefill.
     *
    ...
    /**
     * Constructor for a builder that uses the given dimensions as the
     * dimensions of the Bitmaps to prefill.
     *
    ...
    /**
     * Sets the {@link android.graphics.Bitmap.Config} for the Bitmaps to
     * pre-fill.
     *
    ...
    /**
     * Sets the weight to use to balance how many Bitmaps of this type are
     * prefilled relative to the other requested types.
     *
     * @param weight An integer indicating how to balance pre-filling this size
     *     and configuration of
     *               {@link android.graphics.Bitmap} against any other
