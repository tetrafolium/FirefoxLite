 ...
 * that returns a generated {@link com.bumptech.glide.RequestManager}
 * implementation.
 *
 * <p>Generated {@link
 * com.bumptech.glide.manager.RequestManagerRetriever.RequestManagerFactory}
...
final class RequestManagerFactoryGenerator {
  ...
  RequestManagerFactoryGenerator(ProcessingEnvironment processingEnv) {
    ...
    TypeElement requestManagerType =
    ...
    return TypeSpec.classBuilder(GENERATED_REQUEST_MANAGER_FACTORY_SIMPLE_NAME)
        ...
        .addMethod(
            MethodSpec.methodBuilder("build")
                ...
                .addParameter(ClassName.get(requestManagerTreeNodeType),
                              "treeNode")
                .addStatement("return new $T(glide, lifecycle, treeNode)",
                              ClassName.get(generatedCodePackageName,
