...
public class TabChromeClient {
  ...
  public boolean onShowFileChooser(
      TabView tabView, @Nullable ValueCallback<Uri[]> filePathCallback,
   ...
   * mode. <p> The callback needs to be invoked to request the page to exit full
   * screen mode. <p> Some TabView implementations may pass a custom View which
   * contains the web contents in full screen mode.
   */
   ...
   * mode. <p> If a View was passed when the application entered full screen
   * mode then this view must be hidden now.
   */
