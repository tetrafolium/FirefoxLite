...
public class UrlUtilsTest {
  ...
  public void urlsMatchExceptForTrailingSlash() throws Exception {
    assertTrue(UrlUtils.urlsMatchExceptForTrailingSlash(
    ...
    assertFalse(UrlUtils.urlsMatchExceptForTrailingSlash(
        "http://mozilla.org", "http://www.mozilla.org"));
    assertFalse(UrlUtils.urlsMatchExceptForTrailingSlash(
        "http://www.mozilla.org/", "http://mozilla.org"));
    ...
    assertFalse(UrlUtils.urlsMatchExceptForTrailingSlash(
        "http://www.allizom.org", "http://www.mozilla.org"));
    assertFalse(UrlUtils.urlsMatchExceptForTrailingSlash(
        "http://www.allizom.org/", "http://www.mozilla.org"));
    assertFalse(UrlUtils.urlsMatchExceptForTrailingSlash(
        "http://www.allizom.org", "http://www.mozilla.org/"));
  ...
  public void testStripUserInfo() {
    ...
    assertEquals(
        ...
        UrlUtils.stripUserInfo("https://user:password@www.mozilla.org"));
    assertEquals("https://www.mozilla.org",
                 UrlUtils.stripUserInfo("https://user@www.mozilla.org"));

    assertEquals("user@mozilla.org",
                 UrlUtils.stripUserInfo("user@mozilla.org"));

    assertEquals("ftp://mozilla.org",
                 UrlUtils.stripUserInfo("ftp://user:password@mozilla.org"));
  ...
  public void isInternalErrorURL() {
    assertTrue(
        UrlUtils.isInternalErrorURL("data:text/html;charset=utf-8;base64,"));

    assertFalse(UrlUtils.isInternalErrorURL("http://www.mozilla.org"));
    assertFalse(
        UrlUtils.isInternalErrorURL("https://www.mozilla.org/en-us/about"));
  ...
  public void stripCommonSubdomains() {
    ...
    assertEquals(UrlUtils.stripCommonSubdomains("mobile.mozilla.org"),
                 "mozilla.org");
    assertEquals(UrlUtils.stripCommonSubdomains("www.synology.com"),
                 "synology.com");
  ...
  public void stripHttp() {
    ...
    assertEquals(UrlUtils.stripHttp("https://mobile.mozilla.org"),
                 "mobile.mozilla.org");
    assertEquals(UrlUtils.stripHttp("ftp://quickconnect.to"),
                 "ftp://quickconnect.to");
