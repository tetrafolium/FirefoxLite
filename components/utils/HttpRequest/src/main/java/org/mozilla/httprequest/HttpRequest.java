...
public class HttpRequest {
  ...
  private static String readLines(URLConnection connection) throws IOException {
    ...
    try {
      ...
      // bundled within the android framework, we can only catch the exception
      // here, or use the latest okHttp3.
      return "";
    }
  ...
  private static BufferedReader createReader(InputStream stream)
      throws IOException {
