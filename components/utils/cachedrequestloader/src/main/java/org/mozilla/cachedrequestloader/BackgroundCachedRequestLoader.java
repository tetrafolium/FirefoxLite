...
public class BackgroundCachedRequestLoader
  ...
  public BackgroundCachedRequestLoader(Context context, String subscriptionKey,
  ...
  @VisibleForTesting
  BackgroundCachedRequestLoader(Context context, String subscriptionKey,
                                String subscriptionUrl, String userAgent,
  ...
  public void loadFromCache(Context context, String subscriptionKey,
    ...
    backgroundExecutorService.submit(() -> {
      try {
        ...
        String string = FileUtils.readStringFromFile(
  ...
  public void loadFromRemote(Context context, ResponseData stringLiveData,
    ...
    backgroundExecutorService.submit(() -> {
      ...
      try {
        ...
        stringLiveData.postValue(
            new Pair<>(ResponseData.SOURCE_NETWORK, string));
