...
public class BackgroundCachedRequestLoaderTest {
  ...
  public void testLoadAndCacheLoadFaster() throws InterruptedException {
    ...
    BackgroundCachedRequestLoader cachedRequestLoader =
        new BackgroundCachedRequestLoader(context, KEY, targetUrl, null,
                                          SOCKET_TAG, false, true);
    ...
    Thread.sleep(1000);
    BackgroundCachedRequestLoader urlSubscription2 =
        new BackgroundCachedRequestLoader(InstrumentationRegistry.getContext(),
                                          KEY, targetUrl, null, SOCKET_TAG,
                                          false, true);
  ...
  public void testLoadAndCacheCacheFaster() throws InterruptedException {
    ...
    BackgroundCachedRequestLoader cachedRequestLoader =
        new BackgroundCachedRequestLoader(InstrumentationRegistry.getContext(),
                                          KEY2, targetUrl, null, SOCKET_TAG,
                                          true, false);
    LiveData<Pair<Integer, String>> liveData =
        cachedRequestLoader.getStringLiveData();
    liveData.observeForever(observer);
